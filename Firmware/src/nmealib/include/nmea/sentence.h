...
enum nmeaPACKTYPE
{
    GPNON   = 0x00,	/**< Unknown packet type. */
    GPGGA   = 0x01,	/**< GGA - Essential fix data which provide 3D location and accuracy data. */
    GPGSA   = 0x02,	/**< GSA - GPS receiver operating mode, SVs used for navigation, and DOP values. */
    GPGSV   = 0x04,	/**< GSV - Number of SVs in view, PRN numbers, elevation, azimuth & SNR values. */
    GPRMC   = 0x08,	/**< RMC - Recommended Minimum Specific GPS/TRANSIT Data. */
    GPVTG   = 0x10	/**< VTG - Actual track made good and speed over ground. */
};
