...
#define portNVIC_SYSTICK_CURRENT_VALUE_REG	( * ( ( volatile unsigned int * ) 0xe000e018 ) )
...
#define portAIRCR_REG						( * ( ( volatile unsigned int * ) 0xE000ED0C ) )
...
#define portFPCCR					( ( volatile unsigned int * ) 0xe000ef34 ) /* Floating point context control register. */
 ...
 */
	...
	static unsigned int ulTimerCountsForOneTick = 0;
 ...
 */
#if configUSE_TICKLESS_IDLE == 1
	static unsigned int xMaximumPossibleSuppressedTicks = 0;
#endif /* configUSE_TICKLESS_IDLE */
 ...
 */
#if configUSE_TICKLESS_IDLE == 1
	static unsigned int ulStoppedTimerCompensation = 0;
#endif /* configUSE_TICKLESS_IDLE */
 ...
 */
	 ...
	 static unsigned int ulMaxPRIGROUPValue = 0;
...
portBASE_TYPE xPortStartScheduler( void )
{
	#if( configASSERT_DEFINED == 1 )
	{
		volatile unsigned int ulOriginalPriority;
...
/*-----------------------------------------------------------*/
	...
	{
	unsigned int ulReloadValue, ulCompleteTickPeriods, ulCompletedSysTickDecrements;
...
__asm unsigned int ulPortSetInterruptMask( void )
{
	PRESERVE8
...
__asm void vPortClearInterruptMask( unsigned int ulNewMask )
{
	PRESERVE8
...
__asm unsigned int vPortGetIPSR( void )
{
	PRESERVE8
...
/*-----------------------------------------------------------*/
	...
	{
	unsigned int ulCurrentInterrupt;
