...
typedef struct tskTaskControlBlock
{
	...
	signed char				pcTaskName[ configMAX_TASK_NAME_LEN ];/*< Descriptive name given to the task when created.  Facilitates debugging only. */
		...
		unsigned int ulRunTimeCounter;			/*< Stores the amount of time the task has spent in the Running state. */
	#endif
...
PRIVILEGED_DATA static volatile portTickType xNextTaskUnblockTime				= portMAX_DELAY;
	...
	PRIVILEGED_DATA static unsigned int ulTaskSwitchedInTime = 0UL;	/*< Holds the value of a timer/counter the last time a task was switched in. */
	PRIVILEGED_DATA static unsigned int ulTotalRunTime = 0UL;			/*< Holds the total amount of execution time as defined by the run time counter clock. */
...
tskTCB * pxNewTCB;
	...
	if( pxNewTCB != NULL )
	{
		...
		#if( portSTACK_GROWTH < 0 )
		{
			...
			configASSERT( ( ( ( unsigned int ) pxTopOfStack & ( unsigned int ) portBYTE_ALIGNMENT_MASK ) == 0UL ) );
		}
		#else /* portSTACK_GROWTH */
		{
			...
			configASSERT( ( ( ( unsigned int ) pxNewTCB->pxStack & ( unsigned int ) portBYTE_ALIGNMENT_MASK ) == 0UL ) );
...
/*----------------------------------------------------------*/
	...
	xTaskStatusType *pxTaskStatusArray;
	volatile unsigned portBASE_TYPE uxArraySize, x;
	unsigned int ulTotalTime, ulStatsAsPercentage;
